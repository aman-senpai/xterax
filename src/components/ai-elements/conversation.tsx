...
export const Conversation = ({ className, ...props }: ConversationProps) => (
  <StickToBottom
    className={cn(
      "relative min-h-0 min-w-0 flex-1 overflow-y-auto scrollbar-visible",
      className,
    )}
    initial="smooth"
    resize="smooth"
...
export const ConversationContent = ({
  ...
  <StickToBottom.Content
    scrollClassName="scrollbar-visible min-h-0"
    className={cn("flex min-w-0 flex-col gap-5 p-4", className)}
    {...props}
  />
);
